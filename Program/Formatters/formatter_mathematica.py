...
class MathematicaFormatter(EquationFormatter):
    ...
    def get_equation(equation, order=0):
        ...
        for key in keys:
            ...
            string_key = MathematicaFormatter.get_rate(key)
            ...
            if len(decay_states) > 0 and len(create_states) == 0:
                ...
                if len(decay_states) == 1:
                    ...
                    # Create the string.
                    decay_string = f"-{string_key} (" + "+". join(decay_states) + ")"
            ...
            # If there are no decay states, but there are creation states.
                ...
                if len(create_states) == 1:
                    ...
                    # Create the string.
                    create_string = f"+{string_key} (" + "+".join(create_states) + ")"
            ...
            # If there are both decay states and creation states.
                ...
                # Join the strings.
                equation_string += f"+{string_key} (" + create_string + decay_string + ")"
    ...
    def get_state(state, order=0):
        ...
        if len(denominator_states) > 0:
            ...
            # Format the string.
            state_string = f"{state_string} /(" + " ".join(denominator_states) + ")"
